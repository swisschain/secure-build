...
echo "ibmcloud hpvs instance-create $BUILD_SERVER free fra05 --rd-path "secure_build.asc" -i 1.3.0.4 $certs" > temp
sh temp
echo "---------------------------------------------------------------------"
